defmodule ESI.API.Character do
  ...
  @type search_opt :: {:categories, [:agent | :alliance | :character | :constellation | :corporation | :faction | :inventory_type | :region | :solar_system | :station | :structure]} | {:language, nil | :en | :"en-us" | :de | :fr | :ja | :ru | :zh | :ko | :es} | {:search, String.t} | {:strict, nil | boolean} | {:token, nil | String.t}
