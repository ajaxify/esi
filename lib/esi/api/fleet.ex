defmodule ESI.API.Fleet do
  ...
  @type members_opt :: {:language, nil | :en | :"en-us" | :de | :fr | :ja | :ru | :zh | :ko | :es} | {:token, nil | String.t}
  ...
  def members(fleet_id, opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/fleets/#{fleet_id}/members/",
      opts_schema: %{datasource: {:query, :optional}, language: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def create_members(fleet_id, opts \\ []) do
    %ESI.Request{
      verb: :post,
      path: "/fleets/#{fleet_id}/members/",
      opts_schema: %{datasource: {:query, :optional}, invitation: {:body, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def update_squad(fleet_id, squad_id, opts \\ []) do
    %ESI.Request{
      verb: :put,
      path: "/fleets/#{fleet_id}/squads/#{squad_id}/",
      opts_schema: %{datasource: {:query, :optional}, naming: {:body, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def update_member(fleet_id, member_id, opts \\ []) do
    %ESI.Request{
      verb: :put,
      path: "/fleets/#{fleet_id}/members/#{member_id}/",
      opts_schema: %{datasource: {:query, :optional}, movement: {:body, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  @type wings_opt :: {:language, nil | :en | :"en-us" | :de | :fr | :ja | :ru | :zh | :ko | :es} | {:token, nil | String.t}
  ...
  def update_fleet(fleet_id, opts \\ []) do
    %ESI.Request{
      verb: :put,
      path: "/fleets/#{fleet_id}/",
      opts_schema: %{datasource: {:query, :optional}, new_settings: {:body, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
end