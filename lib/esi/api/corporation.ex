defmodule ESI.API.Corporation do
  ...
  def industry_jobs(corporation_id, opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/corporations/#{corporation_id}/industry/jobs/",
      opts_schema: %{datasource: {:query, :optional}, include_completed: {:query, :optional}, page: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  def starbase(corporation_id, starbase_id, opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/corporations/#{corporation_id}/starbases/#{starbase_id}/",
      opts_schema: %{datasource: {:query, :optional}, system_id: {:query, :required}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
  ...
  @type structures_opt :: {:language, nil | :en | :"en-us" | :de | :fr | :ja | :ru | :zh | :ko | :es} | {:page, nil | integer} | {:token, nil | String.t}
  ...
  def structures(corporation_id, opts \\ []) do
    %ESI.Request{
      verb: :get,
      path: "/corporations/#{corporation_id}/structures/",
      opts_schema: %{datasource: {:query, :optional}, language: {:query, :optional}, page: {:query, :optional}, token: {:query, :optional}},
      opts: Map.new(opts),
    }
  end
